...
/**
 * Bitmap bitmap = null;
				Log.i(tag, "arg2 % imageIds.length:"+arg2 % imageIds.length);
...
//							editMessage.setSelection(index1 + description1[arg2].length());
				...
				gird2.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
						...
						// TODO Auto-generated method stub
						int index2 = Math.max(editMessage.getSelectionStart(), 0);
						String oriContent2 = editMessage.getText().toString();
						...
						if (arg2 == 12) {
							...
							editMessage.setText(sBuilder2.toString());
							editMessage.setSelection(index2 + description2[arg2].length());
						}
