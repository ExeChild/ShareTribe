...
import com.atm.charonline.bbs.bean.Department;
...
//					if(deparList.size()!=0){
//						Log.i(tag, "departlist不为空");
//					}
//					Log.i(tag, "departlist:"+deparList.size());
//					adapter = new DepartAdapter(BBSDepartmentView.this, R.layout.bbs_depar_list_item , deparList);
